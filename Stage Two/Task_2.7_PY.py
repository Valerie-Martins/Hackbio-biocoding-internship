...
#Select numeric columns in the dataframe and fill them with zero(0)
...
#Plot the distribution of BMI, Weight, Weight(pounds), and Age with a histogram
...
#Mean of 60 second pulse rate (including zero values)
df["Pulse"].mean()

#Mean of 60 second pulse rate (without inputed zero values, since it will affect the mean)
